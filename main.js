...
function activateMenuAtCurrentSection(section) {
  ...
  const sectionEndPassdTargetLine = sectionEndsAt <= targetLine

  console.log("O fundo da seção passou d linha?"),
  sectionEndPassdTargetLine

  // limite da seção
  const sectionBoundaries = sectionTopReachOrPassedTargetLine && !sectionEndPassdTargetLine
